...
function NewBnsModal({ id, refetch }) {
  /* API FUNCTION */
  ...
  return (
    <dialog ref={form} id={id} className="modal p-6">
      <div className="modal-box h-[99%] bg-white">
        ...
        <div className="flex gap-6">
          <button
            className="w-full text-[14px] bg-gray-500 text-white py-[12px] px-[8px] rounded-md hover:opacity-50 mb-4"
            onClick={() => {
              form.current.close();
              setFormData({
                firstname: "",
          ...
          <button
            className="w-full text-[14px] bg-[#4CAF50] text-white py-[12px] px-[8px] rounded-md hover:opacity-50 mb-4 disabled:opacity-10"
            disabled={
